...
captions_list = {
    ...
    "adulthood": ["Ваша дочь заканчивает школу,помнишь мама?", "А это я закончил 9 классов,спасибо что всегда была рядом!","Ваша годовщина свадьбы,уже 25 лет вместе,люблю вас!"]
}
